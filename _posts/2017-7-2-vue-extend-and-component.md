...
<a class="jsbin-embed" href="https://jsbin.com/vuhataq/1/embed?js,output">JS Bin on jsbin.com</a><script src="//static.jsbin.com/js/embed.min.js?4.0.4"></script>

其实内部调用了 `Vue.extend`：

<a class="jsbin-embed" href="https://jsbin.com/vuhataq/embed?js,output">JS Bin on jsbin.com</a><script src="//static.jsbin.com/js/embed.min.js?4.0.4"></script>
